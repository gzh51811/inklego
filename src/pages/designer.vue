      ...
      <div class="content_top">
        <div id="title">
          <ul class="title_content">
            ...
            <li>
              <p>文创娱乐</p>
              <p>CULTURAL RECREATION</p>
            </li>
            <li>
              <p>书法字设</p>
              <p>CALLIGRAPHY DESIGN</p>
            </li>
            <li>
              <p>明星应援</p>
              <p>STAR WHO</p>
        ...
        <div id="designer">
          <ul v-for="(list,idx) in this.designerList.data">
            <li @click="DList(list.id)">
              <img :src="list.thumb" style="height:70px;border-radius: 50%;" alt>
            </li>
            ...
            <li @click="guanzhu">
              <span class="ink-icon iconfont icon-plus"></span>
              <p>
            ...
            <li @click="DList(list.id)">
              <div class="text-danger">{{list.dtCount}}</div>
              <p>
                <small>more</small>
              </p>
            </li>
